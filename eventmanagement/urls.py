...
urlpatterns +=[
    ...
    path('staff-view-discharge-student',views.staff_view_discharge_student_view,name='staff-view-discharge-student'),
...
urlpatterns +=[
    ...
    path('student-event', views.student_event_view,name='student-event'),
